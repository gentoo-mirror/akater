...
src_configure() {
	...
	# use accessibility || mozconfig_add_options_ac '' --disable-accessibility
	...
	mozconfig_add_options_ac '' MOZ_X11=1
	mozconfig_add_options_ac '' USE_X11=1
	...
	mozconfig_add_options_ac '' MOZ_ENABLE_WAYLAND=0
	...
	echo "export USE_X11=1" >> "${S}"/.mozconfig
	echo "export MOZ_ENABLE_WAYLAND=0" >> "${S}"/.mozconfig
	#######
