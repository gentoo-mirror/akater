...
inherit autotools elisp-common flag-o-matic readme.gentoo-r1 toolchain-funcs git-extras
...
IUSE="acl alsa aqua athena cairo dbus dynamic-loading games gconf gfile gif +gmp gpm gsettings gtk gtk2 gui gzip-el harfbuzz imagemagick +inotify jit jpeg json kerberos lcms libxml2 livecd lto m17n-lib mailutils minimal png selinux sound source ssl svg systemd +threads tiff toolkit-scroll-bars wide-int Xaw3d xft +xpm xwidgets zlib"
RESTRICT="test"
